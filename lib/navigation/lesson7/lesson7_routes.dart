...
import 'package:flutter_notlarim/navigation/lesson7/lesson7_blue_page.dart';
import 'package:flutter_notlarim/navigation/lesson7/lesson7_red_page.dart';
import 'package:flutter_notlarim/navigation/lesson7/onGenerateRoute_methodum_lesson7.dart';

void main() => runApp(lesson7_routes());

class lesson7_routes extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'lesson7_routes',
...
Bu dersin yoruma alınan kısmının sonu*/
      onGenerateRoute: RouteGenerator_lesson7.onGenerateRoute_methodum_lesson7,
    );
  }
}
          ...
          ElevatedButton(
            onPressed: () async {
              int? _gelenSayi = await Navigator.push<int>(
                context,
                CupertinoPageRoute(
                  builder: (redContext) => lesson7_red_page(),
                ),
              );
            ...
            onPressed: () {
              ...
              Navigator.of(context)
                  .push<int>(MaterialPageRoute(
                      builder: (context) => lesson7_red_page()))
                  .then((int? value) {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) => lesson7_blue_page()));
