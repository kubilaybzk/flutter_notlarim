...
import 'package:flutter_notlarim/navigation/lesson7/lesson7_orange_page.dart';
import 'package:flutter_notlarim/navigation/lesson7/lesson7_routes.dart';
import 'package:flutter_notlarim/navigation/lesson7/student_detay.dart';
import 'package:flutter_notlarim/navigation/lesson7/student_list_lesson7.dart';

class RouteGenerator_lesson7 {
  static Route<dynamic>? onGenerateRoute_methodum_lesson7(
...
*/
      ...
      case 'Turuncu_Sayfamız':
        if (defaultTargetPlatform == TargetPlatform.iOS) {
          ...
          debugPrint("//Platform ios ise ios efekti içeren tasarım çalışsın");
          return CupertinoPageRoute(
              builder: (context) => lesson7_orange_page(), settings: settings);
        } else {
          //Platform android ise android efekti içeren tasarım çalışsın
          debugPrint(
              "//Platform android ise android efekti içeren tasarım çalışsın");
