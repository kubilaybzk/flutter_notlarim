...
import 'package:flutter_notlarim/navigation/lesson5/lesson5_blue_page.dart';
import 'package:flutter_notlarim/navigation/lesson5/lesson5_orange_page.dart';
import 'package:flutter_notlarim/navigation/lesson5/lesson5_red_page.dart';
import 'package:flutter_notlarim/navigation/lesson5/onGenerateRoute_methodum.dart';

void main() => runApp(lesson5_routes());

class lesson5_routes extends StatelessWidget {
  @override
...
Bu dersin yoruma alınan kısmının sonu*/
      onGenerateRoute: RouteGenerator.onGenerateRoute_methodum,
    );
  }
}
          ...
          ElevatedButton(
            onPressed: () async {
              int? _gelenSayi = await Navigator.push<int>(
                context,
                CupertinoPageRoute(
                  builder: (redContext) => lesson5_red_page(),
                ),
              );
            ...
            onPressed: () {
              ...
              Navigator.of(context)
                  .push<int>(MaterialPageRoute(
                      builder: (context) => lesson5_red_page()))
                  .then((int? value) {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) => lesson5_blue_page()));
