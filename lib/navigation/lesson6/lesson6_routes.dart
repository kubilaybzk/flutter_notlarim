...
import 'package:flutter_notlarim/navigation/lesson6/lesson6_blue_page.dart';
import 'package:flutter_notlarim/navigation/lesson6/lesson6_orange_page.dart';
import 'package:flutter_notlarim/navigation/lesson6/lesson6_red_page.dart';
import 'package:flutter_notlarim/navigation/lesson6/onGenerateRoute_methodum_l6.dart';
import 'package:flutter_notlarim/navigation/lesson6/onGenerateRoute_methodum_l6.dart';

void main() => runApp(lesson6_routes());

class lesson6_routes extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'lesson6_routes',
...
Bu dersin yoruma alınan kısmının sonu*/
      onGenerateRoute: RouteGenerator_l6.onGenerateRoute_methodum_l6,
    );
  }
}
          ...
          ElevatedButton(
            onPressed: () async {
              int? _gelenSayi = await Navigator.push<int>(
                context,
                CupertinoPageRoute(
                  builder: (redContext) => lesson6_red_page(),
                ),
              );
            ...
            onPressed: () {
              ...
              Navigator.of(context)
                  .push<int>(MaterialPageRoute(
                      builder: (context) => lesson6_red_page()))
                  .then((int? value) {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) => lesson6_blue_page()));
