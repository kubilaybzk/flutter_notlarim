...
import 'package:flutter_notlarim/navigation/lesson6/student_list.dart';

class RouteGenerator_l6 {
  static Route<dynamic>? onGenerateRoute_methodum_l6(RouteSettings settings) {
...
*/
      ...
      case 'Turuncu_Sayfamız':
        if (defaultTargetPlatform == TargetPlatform.iOS) {
          ...
          debugPrint("//Platform ios ise ios efekti içeren tasarım çalışsın");
          return CupertinoPageRoute(
              builder: (context) => lesson6_orange_page(), settings: settings);
        } else {
          //Platform android ise android efekti içeren tasarım çalışsın
          debugPrint(
              "//Platform android ise android efekti içeren tasarım çalışsın");
